...
```
cd existing_repo
git remote add origin https://gitlab-student.centralesupelec.fr/antonin.decouvelaere/ia-detection-leucemie.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-student.centralesupelec.fr/antonin.decouvelaere/ia-detection-leucemie/-/settings/integrations)
